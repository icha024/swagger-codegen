...
public class SpringMVCServerCodegen extends JavaClientCodegen implements CodegenConfig {
    ...
    public SpringMVCServerCodegen() {
        ...
        supportedLibraries.put("asyncIface", "Use async servlet feature and Java 8's default interface. Generating interface with service " +
                "declaration is useful when using Maven plugin. Provide a implementation with @Controller to instantiate service.");
    ...
    public Map<String, Object> postProcessOperations(Map<String, Object> objs) {
        ...
        if("asyncIface".equals(getLibrary())) {
            apiTemplateFiles.remove(this.templateFileName);
            this.templateFileName = "api-asyncIface.mustache";
            apiTemplateFiles.put(this.templateFileName, ".java");
        }
